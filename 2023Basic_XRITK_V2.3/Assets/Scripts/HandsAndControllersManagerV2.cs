...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    /// </remarks>
    public class HandsAndControllersManagerV2 : MonoBehaviour
    {
        enum Mode
        {
            None,
        ...
        [Header("MotionController Tracking Pose")]
        [SerializeField] Transform motionControllerPosL;
        [SerializeField] Transform motionControllerPosR;


        [Header("TrackedHand Tracking Pose")]
        public VRIK m_VRIK;
        public Transform TrackedHandPosL;
        public Transform TrackedHandPosR;
